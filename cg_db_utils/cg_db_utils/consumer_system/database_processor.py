...
class FullHistoryDatabaseProcessor(BaseDatabaseProcessor):
    ...
    def data_to_db(self):
        ...
        try:
            ...
            print(f"A connection error occured: {error}. Attempting to reconnect.")
            self.receive_connection(connector.get_db_connections())
...
class HistPriceDatabaseProcessor:
    ...
    def data_appending(self, coin_data):
        try:
            ...
            self.error_count += 1
            print(f"{self.error_count} errors have occurred")
            return
    ...
    def data_to_db(self):
        ...
        market_df['timestamp'] = market_df['timestamp'].apply(
        ...
        market_df = market_df.astype(
            {"clean_date": str, "ID": str, "price": float, "volume": float, "market_cap": float})
