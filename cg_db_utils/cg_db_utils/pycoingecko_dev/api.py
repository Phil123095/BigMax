...
class CoinGeckoAPI:
    ...
    def __init__(self, local, regions=DEFAULT_REGIONS, api_base_url=__API_URL_BASE):
        if local:
            dotenv.load_dotenv()
        ...
        self.session.mount('https://api.coingecko.com', self.gateway)

    def __request(self, url):
        # print(url)
        try:
            #self.gateway.get_endpoints_again(self.endpoints)
    ...
    def gateway_close(self):
        # Always make sure to close gateways at END of script run.
